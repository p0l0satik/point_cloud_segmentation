...
class RunConfig(Config):
    def __init__(self) -> None:
        super().__init__()
        self.run_name = "exp_2_basic_unet_ransac"
        self.description = "Basic unet + ransac"
        self.n_epochs = 30
...
if __name__ == "__main__":
    ...
    data = SphericalProjectionKitti(Path("/home/polosatik/mnt/kitti/prep_ransac"), length=4541)
