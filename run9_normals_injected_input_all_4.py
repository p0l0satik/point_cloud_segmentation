...
class RunConfig(Config):
    def __init__(self) -> None:
        super().__init__()
        self.run_name = "exp_9_normals_injected_input_all_4"
        self.description = "Normals with two vectors,starting with up-right (3 channels) and down-left(3 channels are stacked and injected after first tage. Unet has 2 layers, vector length is 1"
        self.n_epochs = 15
...
if __name__ == "__main__":
    ...
    model, optimizer, scheduler = get_model_and_optimizer_interlayer(device, 
