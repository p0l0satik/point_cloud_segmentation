...
class RunConfig(Config):
    def __init__(self) -> None:
        super().__init__()
        self.run_name = "exp_5_basic_unet_ransac_res_01"
        self.description = "Basic unet + ransac, ransac distance threshold is set to 0.1m"
        self.n_epochs = 30
...
if __name__ == "__main__":
    ...
    data = SphericalProjectionKitti(Path("/home/polosatik/mnt/kitti/prep_ransac_01"), length=4541)
