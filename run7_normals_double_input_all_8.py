...
class RunConfig(Config):
    def __init__(self) -> None:
        super().__init__()
        self.run_name = "exp_7_normals_double_input_all_8"
        self.description = "Normals with 4 stacked vectors (12 channels in total): 1 up + 1 right, 1 down + 1 left, and with two pairs of diagonal vectors."
        self.n_epochs = 15
        self.inp_channels = 12
...
if __name__ == "__main__":
    ...
    device = "cuda:0"
    tl, vl, test = get_loaders_param(prep_8_stacked)
