...
class RunConfig(Config):
    def __init__(self) -> None:
        super().__init__()
        self.run_name = "exp_11_normals_len_mixed_1_5"
        self.description = "Normals with increased length to 1 up and 5 right."
        self.n_epochs = 15
...
if __name__ == "__main__":
    ...
    device = "cuda:0"
    tl, vl, test = get_loaders_param(prep_long_5_right_up)
